...
<head>
<title>User Search Friends details</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style7">List All Users Based On Group Key </span></h2>
          ...
          <table width="500" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						...
						String user=(String)application.getAttribute("uname");
      					 String gsign=(String)application.getAttribute("gsign");
						try 
						{
							String status1=null;
						   	String status=null;
						   	String query="select * from user where  gsign='"+gsign+"'  "; 
					...
					%>
            <tr>
              <td width="129" rowspan="3" valign="middle" ><div class="style7" style="margin:10px 13px 10px 13px;" ><a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="images.jsp?id=<%=i%>&value=<%="user"%>" style="width:100px; height:100px;"  />
              </a></div></td>
            </tr>
            <tr>
              <td width="105" height="80" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style9">Name</div></td>
              <td width="90" height="80" valign="middle" bgcolor="#FF0000" style="color:#000000;"><span class="style9">&nbsp;&nbsp;
                <%out.println(s1);%>
              </span></td>
            </tr>
            <tr>
              <td width="105" height="26" valign="middle" bgcolor="#FF00FF" style="color:#000000;"><div align="center" class="style11">Status</div></td>
              <%
						if(status.equals("Already Friend")){
						%>
              <td  width="90" height="26"align="center" valign="middle" bgcolor="#FF00FF" style="color:#000000;"><span class="style11"><%=status %>&nbsp;</span></td>
              <%
						}else if(status.equals("sent")){
						%>
              <td  width="57" height="26"align="center" valign="middle" bgcolor="#FF00FF" style="color:#000000;"><span class="style11"><%=status %>&nbsp;</span></td>
              <%
						}else{
						
						%>
              <td  width="107" height="26"align="center" valign="middle" bgcolor="#FF00FF" style="color:#000000;"><a href="U_UpdateStatus.jsp?username=<%=s1%>&id=<%=i%>" class="style11"><%=status %>&nbsp;</a></td>
              <%}
						%>
            </tr>
            <%
