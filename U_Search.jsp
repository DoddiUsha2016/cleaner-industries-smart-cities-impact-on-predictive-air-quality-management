                  ...
                  <Table align="center" style="margin:0 0 0 30px;">
                    <tr>
                      <td width="174"><div align="center">
                        <div align="right" class="style12">
                          <div align="center" class="style6">Enter Your Keyword </div>
                        </div>
                      </div></td>
                      <td width="152">
                    ...
                    <tr>
                      <td COLSPAN="3"><div class="style2">
                        <div align="center" class="style13 style5">( Searching Datasets Based on Air Quality,City Name)</div>
                      </div></td>
                    </tr>
                  </Table>
               </div>
                <P>&nbsp; </P>
				 ...
				 <p><%
	 				 ...
	 				 try
						...
						long Stime1=System.currentTimeMillis();
								...
								while(rs8.next())
									...
									s2 = rs8.getString("Ci"); // City
									s3 = rs8.getString("AQ"); // Air Quality
					...
					for( i=0;i<splitstr.length;i++)
					{
								...
								if ( (t.contains(splitstr[i])) ||(t1.contains(splitstr[i]))  )
									{
